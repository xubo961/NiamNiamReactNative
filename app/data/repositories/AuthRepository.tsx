...
import {ChangePasswordRequest, UserInterface, UserLogininterface} from "../../domain/entities/User";
...
export class AuthRepositoryImpl implements AuthRepository {
    ...
    async changePassword(request: ChangePasswordRequest): Promise<ApiDeliveryResponse> {
        try {
